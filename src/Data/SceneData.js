export const SceneData = [
  {
    ...
    choices : {
      ...
      choice1 : "You negotiate with the bandits, offering them gold in exchange for sparing the village.",
      choice2 : "You help organize the villagers into a fighting back!",
      choice3 : "You decide to leave the village to avoid getting caught in the conflict." 
    },
    aiPrompt : {
  ...
  {
    sceneNum : 1,
    sceneTitle : "A messenger stops you saying a dying king has asked you to take a relic to a far away temple to ensure peace for his people. But the messenger tells you that the king’s reign was marked by cruelty.",
    choices : {
      ...
      choice2 : "You take the relic, but only if the people of the kingdom prove their worth first.",
  ...
  {
    sceneNum : 3,
    sceneTitle : "You found a cursed relic that promises great power, but comes with a dark curse that could harm you or others.",
    choices : {
      choice0 : "You take the relic, confident that you can manage the curse’s effects.",
      choice1 : "You leave the relic behind, believing that the risk is too great and is not worth the power.",
  ...
  {
    sceneNum : 4,
    sceneTitle : "Your trusted companion suddenly betrays you, taking all your supplies and running off. You confront them at the next village, and they beg for your forgiveness, claiming they had no choice.",
    choices : {
      ...
      choice3 : "You choose to continue your journey together while keeping a watchful eye on their actions." 
    },
    aiPrompt : {
